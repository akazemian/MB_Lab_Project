...
from code_.encoding_score.benchmarks.benchmarks_configs import CACHE, MAJAJ_DATA, PREDS_PATH
from code_.encoding_score.benchmarks.benchmarks_configs import MAJAJ_TRAIN_IDS, MAJAJ_TEST_IDS, TRAIN_IDS_DEMO, TEST_IDS_DEMO, ALPHA_RANGE
